...
const EditProduct = () => {
  ...
  return (
    <div className="admin-container" style={{ maxWidth: '600px' }}>
      <h2 style={{ color: '#f97316', marginBottom: '25px' }}>Edit Product</h2>
      <form onSubmit={handleSubmit} className="admin-form">
        ...
        <textarea placeholder="Description" required rows="4" value={formData.description} onChange={(e) => setFormData({...formData, description: e.target.value})} />
        ...
        <div className="admin-form-upload">
          ...
          <input type="file" accept="image/*" onChange={(e) => setImage(e.target.files[0])} style={{ color: '#fff', cursor: 'pointer' }} />
        </div>
